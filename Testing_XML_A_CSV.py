...
#-------------------------------------------------------------------------------------------------------
    def test_procesar_xml(self):
        ...
        test_file_path = os.path.join(self.leer_xml.in_path, 'test_procesar_xml.xml')
        ...
        self.leer_xml.procesar_xml('test_procesar_xml.xml')
        ...
        processed_file_path = os.path.join(self.leer_xml.out_path, 'test_procesar_xml.xml')
...
#----------------------------------------------------------------------------------------------------
    def test_extraer_fila(self):
        ...
        # Añadir subelementos 'Attribute' y 'Data' con sus atributos correspondientes
            attribute_child = ET.SubElement(registro, '{SAMSettlementDataOutput_v502.xsd}Attribute')
            attribute_child.set('name', 'attribute_name')
            attribute_child.set('value', 'attribute_value')
            attribute_child.set('seq', '1')

            data_child = ET.SubElement(registro, '{SAMSettlementDataOutput_v502.xsd}Data')
    ...
    def test_guardar(self):  # Método de prueba para la función que guarda un DataFrame en un archivo
